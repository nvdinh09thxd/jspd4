...
<title>MUA HOA</title>
<link href="<%=request.getContextPath()%>/baitap/BT2/css/reset.css"
	rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath()%>/baitap/BT2/css/style.css"
	rel="stylesheet" type="text/css" />
</head>
<body>
	<div class="wrapper">
		...
		<form action="<%=request.getContextPath()%>/xu-ly-mua-hoa"
			method="post">
			<label>ID:</label> <input type="text" name="id" /><br /> <br /> <label>Tên:</label>
			<input type="text" name="ten" /><br />
			<br /> <label>Số lượng:</label> <input type="text" name="soluong" /><br />
			<br /> <label>Giá bán:</label> <input type="text" name="gia" /><br />
