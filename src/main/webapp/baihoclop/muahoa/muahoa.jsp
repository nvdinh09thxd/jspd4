...
<html>
	<head>
		...
		<title>Mua hoa</title>
		<link href="<%=request.getContextPath()%>/baihoclop/muahoa/css/reset.css" rel="stylesheet" type="text/css" />
		<link href="<%=request.getContextPath()%>/baihoclop/muahoa/css/style.css" rel="stylesheet" type="text/css" />
	</head>
	<body>
		<div class="wrapper">
			<h2>Mua hoa</h2>
